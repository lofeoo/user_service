...
type Client interface {
	...
	OAuth2Login(ctx context.Context, req *auth.OAuth2LoginRequest, callOptions ...callopt.Option) (r *auth.OAuth2LoginResponse, err error)
}
...
func (p *kAuthServiceClient) OAuth2Login(ctx context.Context, req *auth.OAuth2LoginRequest, callOptions ...callopt.Option) (r *auth.OAuth2LoginResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
